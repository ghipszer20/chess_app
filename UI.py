...
def main():
    ...
    while True:
        ...
        while not valid_start or not valid_end:
            ...
            start_x, start_y = 8 - int(start_y), game.col_map[start_x]
            ...
            while True:
                ...
                end_x, end_y = 8 - int(end_y), game.col_map[end_x]
        ...
        game.set_square("  ", start_x, start_y)
        game.set_square(temp, end_x, end_y)

        if temp[1] == "P" and end_x == 0 or end_x == 7:
            while True:
                promote_to = input("Promote your pawn to a knight, bishop, rook, or queen  (ex: wN): ")
                if promote_to in game.get_white_pieces_map() or promote_to in game.get_black_pieces_map():
